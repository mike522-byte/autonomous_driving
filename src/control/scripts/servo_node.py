...
lane_vel = Twist()
speedcontrol = 1
angularScale = 8       # 180/30,该值越大，转弯的程度越大，该值越小，即倾向于维持直行
servodata=0
...
#障碍检测相反方向
#def oppositecallback(msg):
    #global opposite_dir
    #opposite_dir = msg.data
...
def kinematicCtrl():
    ...
    rospy.Subscriber("/has_obs", Int32, lidarcallback)
    #rospy.Subscriber("/opposite_dir", Int32, oppositecallback)
